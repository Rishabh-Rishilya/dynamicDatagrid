import { DynamicMatrixGridPreviewProps } from "../typings/DynamicMatrixGridProps";
...
export function getProperties(
    values: DynamicMatrixGridPreviewProps,
...
export const getPreview = (
    ...
    const column = (isHeader: boolean): StructurePreviewProps =>
        rowLayout({
            columnSize: "fixed"
        })(
            container({
    ...
    const gridTitle = rowLayout({
        ...
        container({
            padding: 4
        })(text({ fontColor: palette.text.data })("dynamic-matrix-grid"))
    );
