...
function getHeaderValue(props: DynamicMatrixGridContainerProps, column: ObjectItem): ReactNode {
...
function tooltipValue(props: DynamicMatrixGridContainerProps, column: ObjectItem): string {
...
export function Headers(props: DynamicMatrixGridContainerProps): ReactElement {
