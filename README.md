...
dynamic-matrix-grid with variable columns.

This Siemens Energy distribution is version 1.0.0.

Attribution: The base widget idea and original implementation approach were taken from the associated marketplace
widget published by Clevr Solutions / Clevr NL B.V. This version is branded and maintained for Siemens Energy.
...
``` json
{
    "com.risha.dynamicdatagrid.widget.web.dynamicmatrixgrid.DynamicMatrixGrid": [
        {
            "name": "Borders",
            "type": "Dropdown",
